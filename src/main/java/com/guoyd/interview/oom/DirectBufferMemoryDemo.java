package com.guoyd.interview.oom;
 ...
 * MaxDirectMemorySize 默认为 1/4 PC内存
 *
 * 导致原因：
 ...
 *
 * ByteBuffer.allocateDirect(capability)第2种方式是分配OS本地内存，不属于GC管辖范围，由于不需要内存拷贝，所以速度相对较快。
 *
...
public class DirectBufferMemoryDemo {
    public static void main(String[] args) {
        ...
        //-XX:MaxDirectMemorySize=5m 配置为 5m 实际使用为 6m
